const zh = {
    ...
    setupCopySuccess: '初始化命令已复制',
    setupCommandHint: '将 YOUR_JWT_SECRET 替换为 Cloudflare 中配置的 jwt_secret。密钥只放在请求头，不要放进 URL。',
    setupBindingsFirst: '请先在 Cloudflare 中补齐标记为“未配置”的绑定或变量，然后重新部署或检测。',
    setupRefreshStatus: '重新检测',
    setupMaintenanceHint: '维护中心需要管理员登录。首次初始化请使用本页面和受密钥保护的 /api/init。',
    healthIssues: '健康检查',
    safeRepair: '安全修复',
