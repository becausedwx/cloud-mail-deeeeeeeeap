const en = {
    ...
    setupCopySuccess: 'Initialization command copied',
    setupCommandHint: 'Replace YOUR_JWT_SECRET with the configured Cloudflare jwt_secret. Send it only in the request header, never in the URL.',
    ...
    setupMaintenanceHint: 'Maintenance requires an administrator login. For first initialization, use this page and the secret-protected /api/init endpoint.',
    ...
    codeCenterHint: 'Click a code card to copy it. Details opens the original email. Fresh view shows codes from the last 15 minutes by default.',
    copied: 'Copied',
    codeExpiresIn: 'Expires in about {minutes} min',
    codeExpiredHint: 'Expired code, for reference only',
    codeExpiredHidden: 'Expired',
    loadMore: 'Load More',
